...
// Debug logging
console.log('GoldSpice Cart initialized:', window.goldSpiceCart);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Cart count updated, current items:', window.goldSpiceCart.getTotalCount());
    ...
    addToCartButtons.forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            console.log('Product data:', { productId, productName, productPrice, productImage, productPack });
